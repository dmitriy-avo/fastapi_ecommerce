...
"""
----------Схемы реализации Категорий товаров----------
"""
...
"""
----------Схемы реализации Товаров(Product)----------
"""
...
"""
----------Схемы реализации пользователей----------
"""

class UserCreate(BaseModel):
    email: EmailStr = Field(description="Email пользователя")
    password: str = Field(min_length=8, description="Пароль (минимум 8 символов)")
    role: str = Field(default="buyer", pattern="^(buyer|seller)$", description="Роль: 'buyer', 'seller' admin")
...
"""
----------Схемы реализации Обзоров----------
"""

class ReviewCreate(BaseModel):
    product_id: int = Field(..., description="Уникальный идентификатор продукта")
    comment: str | None = Field(default=None, max_length=500, description="Текст комментария")
...
"""
----------Схемы реализации Корзины товаров----------
"""
